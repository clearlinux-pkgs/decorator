...
Version  : 5.0.3
Release  : 70
URL      : https://files.pythonhosted.org/packages/2a/8e/9a5c2d41333e6c87a3d67772dacd383d9d9d303e65c2d6938b627e2de642/decorator-5.0.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/2a/8e/9a5c2d41333e6c87a3d67772dacd383d9d9d303e65c2d6938b627e2de642/decorator-5.0.3.tar.gz
...
%prep
%setup -q -n decorator-5.0.3
cd %{_builddir}/decorator-5.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617402608
...
cp %{_builddir}/decorator-5.0.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/decorator/3483701a3a93cfae3581f5a544e3a21fe01933bc
