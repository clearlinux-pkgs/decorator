...
Source0  : https://files.pythonhosted.org/packages/6a/aa/c194bd2fb168c1ebd8ffbfc12d972d09a9df0e4d485013e5ba2c8e4f1f05/decorator-5.0.6.tar.gz
...
%prep
%setup -q -n decorator-5.0.6
cd %{_builddir}/decorator-5.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617891798
...
cp %{_builddir}/decorator-5.0.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/decorator/3483701a3a93cfae3581f5a544e3a21fe01933bc
