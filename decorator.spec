...
%prep
%setup -q -n decorator-5.0.9
cd %{_builddir}/decorator-5.0.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621263884
...
cp %{_builddir}/decorator-5.0.9/LICENSE.txt %{buildroot}/usr/share/package-licenses/decorator/3483701a3a93cfae3581f5a544e3a21fe01933bc
