...
Source0  : https://files.pythonhosted.org/packages/77/d3/b9fe64cd6d97562488685a8509aff2c1e710c421e2bd22ba698f3fb5e6d0/decorator-5.0.5.tar.gz
...
%prep
%setup -q -n decorator-5.0.5
cd %{_builddir}/decorator-5.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617633640
...
cp %{_builddir}/decorator-5.0.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/decorator/3483701a3a93cfae3581f5a544e3a21fe01933bc
