...
%prep
%setup -q -n decorator-5.0.7
cd %{_builddir}/decorator-5.0.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618410062
...
cp %{_builddir}/decorator-5.0.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/decorator/3483701a3a93cfae3581f5a544e3a21fe01933bc
